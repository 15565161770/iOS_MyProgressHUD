...
@implementation MBProgressHUD (TWHUD)
...
{
    [self showTipMessage:message isWindow:true timer:3];
}
+ (void)showTipMessageInView:(NSString*)message
{
    [self showTipMessage:message isWindow:false timer:3];
}
